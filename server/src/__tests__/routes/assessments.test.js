...
describe("Assessments Routes", () => {
  describe("POST /api/assessments", () => {
    it("should create an assessment", async () => {
      ...
      mockQuery("SELECT * FROM assessments WHERE id", {
        ...ASSESSMENT,
        id: "test-uuid-1",
      });
  ...
  describe("POST /api/assessments/:id/recordings", () => {
    it("should add a recording to an assessment", async () => {
      ...
      mockQuery("SELECT * FROM assessment_recordings WHERE id", {
        id: "test-uuid-1",
        target_type: "excerpt",
        target_id: "exc-1",
      });
