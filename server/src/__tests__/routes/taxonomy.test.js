...
const CATEGORY = { id: 'cat-1', name: 'Scales', parent_id: null, sort_order: 0, description: 'Scale exercises' };
...
describe('Taxonomy Routes', () => {
  ...
  describe('POST /api/taxonomy', () => {
    it('should create a category', async () => {
      ...
      mockQuery('SELECT * FROM taxonomy_categories WHERE id', { ...CATEGORY, id: 'test-uuid-1' });
  ...
  describe('PUT /api/taxonomy/:id', () => {
    it('should update a category', async () => {
      ...
      mockQuery('SELECT * FROM taxonomy_categories WHERE id', { ...CATEGORY, name: 'Updated' });
