...
// Write routes require Pro tier or higher; read routes open to all authenticated users.

// POST — follow a user
router.post(
  "/follow/:userId",
  requireTier("pro", "teacher"),
  asyncHandler(async (req, res) => {
    ...
    res
      .status(201)
      .json({ id, follower_id: req.user.id, following_id: followingId });
  }),
);
