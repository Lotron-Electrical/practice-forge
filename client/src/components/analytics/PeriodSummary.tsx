...
function ComparisonBadge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-0.5 text-xs font-medium ${positive ? "text-[var(--pf-status-ready)]" : "text-[var(--pf-status-needs-work)]"}`}
    >
    ...
    <div>
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div className="text-center">
          ...
          <ComparisonBadge
            current={current.avgLength}
            previous={previous.avgLength}
            unit="m"
          />
        </div>
        <div className="text-center">
