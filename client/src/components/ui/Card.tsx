...
export function Card({ borderColor, className = '', children, ...props }: CardProps) {
  return (
    <div
...
export function CardHeader({ className = '', children, ...props }: HTMLAttributes<HTMLDivElement>) {
  return <div className={`px-5 py-4 border-b border-[var(--pf-border-color)] ${className}`} {...props}>{children}</div>;
}
