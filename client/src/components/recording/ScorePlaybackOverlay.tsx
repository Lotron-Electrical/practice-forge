...
export function ScorePlaybackOverlay({
  fileId, startBar, endBar, onStartBarChange, onEndBarChange,
  currentBar, barResults, isRecording,
}: Props) {
  return (
      ...
      <Card>
        <CardContent className="p-0 overflow-hidden relative">
          ...
          {isRecording && currentBar && (
            <div className="absolute top-2 right-2 px-3 py-1 rounded-pf text-xs font-medium text-white"
