...
describe('SessionPage', () => {
  ...
  it('calls generateSession on button click', async () => {
    const user = userEvent.setup();
    const mockSession = {
      id: 's1', date: '2024-01-01', planned_duration_min: 60,
      actual_duration_min: null, status: 'planned', rating: null, notes: '',
      blocks: [
        { id: 'b1', category: 'warmup', title: 'Warm-up', description: '', planned_duration_min: 10, actual_duration_min: null, sort_order: 0, status: 'pending', linked_type: null, linked_id: null, focus_points: '', notes: '' },
      ],
    };
  ...
  it('shows session blocks after generation', async () => {
    ...
    const mockSession = {
      ...
      actual_duration_min: null, status: 'planned', rating: null, notes: '',
      blocks: [
        { id: 'b1', category: 'warmup', title: 'Long tones', description: 'Sustained notes', planned_duration_min: 10, actual_duration_min: null, sort_order: 0, status: 'pending', linked_type: null, linked_id: null, focus_points: '', notes: '' },
        { id: 'b2', category: 'technique', title: 'Scales', description: 'Major scales', planned_duration_min: 15, actual_duration_min: null, sort_order: 1, status: 'pending', linked_type: null, linked_id: null, focus_points: '', notes: '' },
      ],
    };
    mockApi.generateSession.mockResolvedValue(mockSession as any);
    render(<SessionPage />);
  ...
  it('shows completed session view', async () => {
    mockApi.getCurrentSession.mockResolvedValue({
      id: 's1', date: '2024-01-01', planned_duration_min: 60,
      actual_duration_min: 55, status: 'completed', rating: 'good', notes: 'Great session',
      blocks: [
        { id: 'b1', category: 'warmup', title: 'Warm-up', description: '', planned_duration_min: 10, actual_duration_min: 10, sort_order: 0, status: 'completed', linked_type: null, linked_id: null, focus_points: '', notes: '' },
      ],
    } as any);
    render(<SessionPage />);
    await waitFor(() => {
