...
describe('PiecesPage', () => {
  ...
  it('displays pieces from API', async () => {
    mockApi.getPieces.mockResolvedValue([
      {
        id: '1', title: 'Debussy Syrinx', composer: 'Debussy', status: 'in_progress',
        priority: 'medium', difficulty: 6, target_date: null, sections: [], technical_demands: [],
  ...
  it('shows priority badges on pieces', async () => {
    mockApi.getPieces.mockResolvedValue([
      {
        id: '1', title: 'Test', composer: 'Test', status: 'in_progress',
        priority: 'high', difficulty: null, target_date: null, sections: [], technical_demands: [],
        colour_tag: null, general_notes: '', historical_context: null, created_at: '', updated_at: '',
      },
    ] as any);
    render(<PiecesPage />);
