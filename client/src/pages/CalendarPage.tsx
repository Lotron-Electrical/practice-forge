      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-7 gap-1 mb-1">
              {DAY_LABELS.map((d) => (
                <div
                  key={d}
                  className="text-center text-xs font-medium text-[var(--pf-text-secondary)] py-1"
                >
                  {d}
                </div>
              ))}
        ...
        <div className="space-y-4">
            ...
            <CardContent className="space-y-2">
              ...
              {monthDays.length > 0 && (
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {Math.round(monthMinutes / monthDays.length)}m
                  </span>
                </div>
              )}
            </CardContent>
          ...
          {selectedDay && (
            <Card
              borderColor={
                selectedDay.minutes > 0 ? "var(--pf-accent-gold)" : undefined
              }
            >
              <CardHeader>
                <h3 className="text-sm font-semibold">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span
                          className={`font-medium capitalize ${
                            selectedDay.rating === "good"
                              ? "text-[var(--pf-status-ready)]"
                              : selectedDay.rating === "bad"
