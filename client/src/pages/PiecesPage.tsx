          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Input
                ...
                placeholder="e.g. Mozart Flute Concerto No. 1 in G major, K. 313"
              />
              <Input
                label="Composer"
                value={form.composer}
                  ...
                  <CardContent className="flex flex-col sm:flex-row sm:items-center gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-1 flex-wrap">
                        ...
                        <Badge
                          color={
                            priorityConf.label === "High"
                              ? "var(--pf-status-needs-work)"
                              : priorityConf.label === "Medium"
                                ? "var(--pf-accent-gold)"
                      ...
                      <div className="flex items-center gap-4 text-sm text-[var(--pf-text-secondary)] flex-wrap">
                        ...
                        <span>
                          {piece.technical_demands.length} tricky spots
                        </span>
                      </div>
                    </div>
                    {/* Section progress */}
                    ...
                    {daysUntil != null && (
                      <span
                        className={`text-sm font-medium ${daysUntil <= 7 ? "text-[var(--pf-status-needs-work)]" : "text-[var(--pf-text-secondary)]"}`}
                      >
                        {daysUntil > 0
                          ? `${daysUntil} days`
                          : daysUntil === 0
