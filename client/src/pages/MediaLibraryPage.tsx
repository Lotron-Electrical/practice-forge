          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold">
                Edit: {editingFile.original_filename}
              </h2>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Select
                ...
                onChange={(e) =>
                  setEditForm((f) => ({ ...f, file_type: e.target.value }))
                }
              >
                <option value="sheet_music_digital">
                  Sheet Music (Digital)
                </option>
                <option value="sheet_music_scanned">
                  Sheet Music (Scanned)
                </option>
                <option value="audio">Audio</option>
                <option value="video">Video</option>
              ...
              <Select
                label="Linked Type"
                value={editForm.linked_type}
                onChange={(e) =>
                  setEditForm((f) => ({ ...f, linked_type: e.target.value }))
                }
              >
              ...
              {editForm.linked_type && (
                <Input
                  label="Linked ID"
                  value={editForm.linked_id}
                  onChange={(e) =>
                    setEditForm((f) => ({ ...f, linked_id: e.target.value }))
                  }
