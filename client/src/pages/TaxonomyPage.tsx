...
function CategoryNode({
  ...
  node: TreeNode;
  depth: number;
  onEdit: (cat: TaxonomyCategory) => void;
      ...
      >
        {hasChildren ? (
          <button
            ...
            className="p-2 sm:p-0.5 text-[var(--pf-text-secondary)]"
        ...
        {hasChildren && (
          <Badge color="var(--pf-text-secondary)" className="mr-2">
...
export function TaxonomyPage() {
  ...
  const load = useCallback(() => {
    api
      .getTaxonomy()
      .then((data) => setCategories(data as TaxonomyCategory[]))
      .catch(() => {});
  }, []);
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Input
                ...
                placeholder="e.g. Flutter Tonguing"
              />
              <div className="flex flex-col gap-1">
                <label className="text-sm font-medium text-[var(--pf-text-secondary)]">
                  Parent category
                </label>
                <select
                  value={formParent}
